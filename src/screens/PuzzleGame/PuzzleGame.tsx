...
export function PuzzleGame({ onBack, dark, onToggleTheme }: Props) {
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div className="flex items-center gap-4 px-4 py-3 border-b border-brand-purple/15 dark:border-brand-cream/10 shrink-0">
        <button
          onClick={onBack}
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="w-24 h-1.5 rounded-full bg-brand-purple/15 dark:bg-brand-cream/10 overflow-hidden">
            <div
      ...
      {/* Mobile tab bar */}
      <div className="md:hidden flex border-b border-brand-purple/15 dark:border-brand-cream/10 shrink-0">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Divider */}
        <div className="hidden md:block w-px bg-brand-purple/15 dark:bg-brand-cream/10 shrink-0" />
...
function CompletionOverlay({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-40">
      <div className="bg-brand-cream dark:bg-brand-purple rounded-3xl p-8 flex flex-col items-center gap-4 shadow-2xl">
        <p className="text-2xl font-semibold text-brand-purple dark:text-brand-cream">Puzzle complete!</p>
